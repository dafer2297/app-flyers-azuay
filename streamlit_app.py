...
def generar_tipo_2_v2(datos):
    ...
    # 4. Desc2 (Izquierda, sobre la caja de fecha) <-- MODIFICADO AQUI
    desc2 = datos.get('desc2', "")
    s_desc2 = 68
    f_desc2 = get_font("Canaro-Medium.ttf", s_desc2)
...
def generar_tipo_2_v4(datos):
    ...
    limit_y = min(y_desc2_top, y_firma_top) - 50 # <-- AHORA LIMITA CON LA DESC2
    y_start_desc1 = y_titulo + 180 
    max_h_desc1 = limit_y - y_start_desc1
...
def generar_tipo_5_v4(datos):
    ...
    return img.convert("RGB")
# ==============================================================================
# 8. GENERADORES DE PLANTILLAS TIPO 6 (1 Fecha, 2 Desc, 3 Logos Superiores)
# ==============================================================================
...
# ==============================================================================
# NUEVO: 11. GENERADORES DE PLANTILLAS TIPO 9 (1 Desc, 1 Fecha, 2 Colaboradores)
# ==============================================================================
...
def generar_tipo_9_v1(datos):
    ...
    # 3. 2 Logos Colaboradores (Abajo Derecha)
    collab1 = None
    collab2 = None
...
# ==============================================================================
# 12. INTERFAZ DE USUARIO Y LOGICA PRINCIPAL
# ==============================================================================
...
if not area_seleccionada:
    ...
    with col_der:
        ...
        st.markdown("<div class='label-negro'>LOGOS COLABORADORES (OPCIONAL - MAX 2)</div>", unsafe_allow_html=True)
        
        rutas_memoria = st.session_state.get('rutas_logos', [])
        if rutas_memoria and os.path.exists(rutas_memoria[0]):
            st.success(f"✅ {len(rutas_memoria)} LOGO(S) GUARDADO(S).")
            if st.button("❌ ELIMINAR LOGOS GUARDADOS", type="primary"):
        ...
        if st.button("✨ GENERAR FLYERS ✨", type="primary", use_container_width=True):
            ...
            if errores:
                ...
                if logos:
                    rutas_logos = []
                    # Solo tomamos maximo 2 logos
                    for i, l in enumerate(logos[:2]):
