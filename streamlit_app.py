...
def generar_tipo_1_v2(datos):
    ...
    # 1. Calculo EXACTO de la parte superior del Bloque Ubicacion (ALINEACION INFERIOR)
    lugar = datos['lugar']
    s_lug = 61 if len(lugar) < 45 else 51
    f_lugar = get_font("Canaro-Medium.ttf", s_lug)
...
def generar_tipo_1_v3(datos):
    ...
    # 1. Calculo Exacto Ubicacion (Derecha) - NUEVA ALINEACION
    lugar = datos['lugar']
    s_lug = 61 if len(lugar) < 45 else 51
    f_lugar = get_font("Canaro-Medium.ttf", s_lug)
    lines_loc = wrap_text_pixel(lugar, f_lugar, 800)
...
def generar_tipo_1_v4(datos):
    ...
    # 1. Calculo Exacto Ubicacion (Izquierda) - NUEVA ALINEACION
    lugar = datos['lugar']
    s_lug = 61 if len(lugar) < 45 else 51
    f_lugar = get_font("Canaro-Medium.ttf", s_lug)
    lines_loc = wrap_text_pixel(lugar, f_lugar, 1000)
...
def generar_tipo_9_v1(datos):
    ...
    f_lugar = get_font("Canaro-Medium.ttf", s_lug)
    loc_max_w = 560
    lines_loc = wrap_text_pixel(lugar, f_lugar, loc_max_w)
    total_h_loc = len(lines_loc) * int(s_lug * 1.1)
    h_icon = 221
...
def generar_tipo_9_v2(datos):
    ...
    # 3. Calculo Exacto Ubicacion (Izquierda Abajo) - ALINEACION INFERIOR
    lugar = datos['lugar']
    s_lug = 61 if len(lugar) < 45 else 51
    f_lugar = get_font("Canaro-Medium.ttf", s_lug)
    lines_loc = wrap_text_pixel(lugar, f_lugar, 1000)
