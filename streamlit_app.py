...
def generar_tipo_1(datos):
    ...
    if datos['hora2']: 
        ...
        size_h = 80 # Se reduce si hay dos horas
    ...
    # Dibujar elementos dentro de la caja
...
def generar_tipo_2_v1(datos):
    ...
    if desc2:
        ...
        # Anclamos la descripción 2 para que esté a 50px exactos por encima de la caja
...
def generar_tipo_3_v3(datos):
    ...
    # DISTANCIA FIJA DESDE EL TÍTULO
    y_desc = y_titulo + 70 + s_desc
...
def generar_tipo_4_v1(datos):
    ...
    # Descripción 2 (Izquierda, encima de la caja larga)
    desc2 = datos['desc2']
    if desc2:
        s_desc2 = 80 
        path_medium = ruta_abs("Canaro-Medium.ttf")
        ...
        # Anclamos la descripción 2 a 50px exactos sobre la caja larga
        y_cursor_d2 = y_box - 50 - total_h_d2 + h_line_d2
        for line in lines_d2:
            dibujar_texto_sombra(draw, line, x_box, y_cursor_d2, f_desc2, offset=(5,5), anchor="ls") 
            y_cursor_d2 += h_line_d2
...
def generar_tipo_4_v2(datos):
    ...
    # --- DESCRIPCIÓN 2 ENCIMA DEL RECUADRO (T4_V2 Especificación) ---
    desc2 = datos['desc2']
    if desc2:
        s_desc2 = 80
        path_medium = ruta_abs("Canaro-Medium.ttf")
        ...
        lines_d2 = textwrap.wrap(desc2, width=22) # Ancho adaptado a la caja
        h_line_d2 = int(s_desc2 * 1.1)
        total_h_d2 = len(lines_d2) * h_line_d2
        
        # Anclada 50px sobre la caja larga a la izquierda
        y_cursor_d2 = y_box - 50 - total_h_d2 + h_line_d2
    ...
    with col_der:
        ...
        if st.button("✨ GENERAR FLYERS ✨", type="primary", use_container_width=True):
            ...
            if errores:
                ...
                if has_fecha2 and has_desc2 and num_logos == 0:
